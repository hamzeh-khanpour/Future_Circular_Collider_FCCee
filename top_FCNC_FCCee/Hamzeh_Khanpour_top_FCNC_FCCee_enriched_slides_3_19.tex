...
\vspace{-1ex}
\centering
line shape + ratios + asymmetries + $\tau$ polarisation\
$\Downarrow$\
...
\scriptsize
\centering
$\sigma(e^+e^-\to W^+W^-;\sqrt{s})$ near threshold\
$\Downarrow$\
...
\centering\footnotesize
EW/$Z/WW$ precision\
$\Downarrow$ calibrated vertices + SMEFT basis\
Higgs precision\
$\Downarrow$ EWSB and Yukawa structure\
Top threshold/365~GeV\
$\Downarrow$ top mass and EW couplings\
Rare top FCNC\
