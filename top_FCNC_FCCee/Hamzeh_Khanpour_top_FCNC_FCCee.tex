...
\small
\justifying 
\textbf{Bottom quark forward-backward asymmetry at the future electron-positron collider FCC-ee}\\
Marina Cobal (Udine U.), Giovanni Guerrieri (Udine U.), Hamzeh Khanpour (AGH), Giancarlo Panizzo (Udine U.), Michele Pinamonti (ICTP), Laura Pintucci (ICTP), Leonardo Toffolin (University of Trieste)\\
...
\small
\justifying 
\textbf{Top quark FCNC anomalous couplings at the future collider FCC-ee}\\
Seddigheh Tizchang (IPM), Hamzeh Khanpour (AGH), Mojtaba Mohammadi Najafabadi (CERN), Patrizia Azzi (INFN Padova), Emmanuel Francois Perez (CERN)\\
